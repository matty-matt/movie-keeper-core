...
import com.kociszewski.movieservice.domain.events.CastSearchDelegatedEvent;
import com.kociszewski.movieservice.domain.events.TrailersSearchDelegatedEvent;
import com.kociszewski.movieservice.domain.queries.GetMovieQuery;
import com.kociszewski.movieservice.external.cast.FetchCastCommand;
import com.kociszewski.movieservice.external.proxy.FetchMovieDetailsCommand;
import com.kociszewski.movieservice.domain.events.MovieSearchDelegatedEvent;
import com.kociszewski.movieservice.external.proxy.MovieDetailsFetchedEvent;
import com.kociszewski.movieservice.external.trailer.FetchTrailersCommand;
...
public class MovieSaga {
    ...
    public void handle(MovieSearchDelegatedEvent event) {
            ...
            associateWith("proxyId", proxyId.toString());
